...
@Component({
  ...
  `<app-observable-player 
          ...
          [operatorDescription]="[
              'Maps to a new inner observable and emits value',
              'Does not wait for previous observable to complete (!= concatMap)'
              ]"
  >
...
export class MergeMapComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.source$ = merge(
      ...
      mergeMap(magazineName => backendSearch(magazineName))
    )
  }
}
